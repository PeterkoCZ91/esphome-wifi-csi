...
// =============================================================================
// HT40 Constants (128 subcarriers)
// =============================================================================
constexpr uint16_t HT40_NUM_SUBCARRIERS = 128;     // HT40: 128 subcarriers
constexpr uint16_t HT40_CSI_LEN = 256;             // 128 SC × 2 bytes (I/Q pairs)
constexpr uint8_t HT40_GUARD_BAND_LOW = 6;         // First valid lower subcarrier
constexpr uint8_t HT40_GUARD_BAND_HIGH = 121;      // Last valid upper subcarrier
constexpr uint8_t HT40_DC_SUBCARRIER = 64;         // DC null subcarrier
constexpr uint8_t HT40_SELECTED_BAND_SIZE = 12;    // Same count as HT20 for compat
// 12 subcarriers evenly spread across both HT40 sub-bands (lower: 6-63, upper: 65-121)
constexpr uint8_t HT40_DEFAULT_SUBCARRIERS[12] = {
    10, 18, 26, 34, 42, 52,   // lower sub-band (pre-DC)
    76, 84, 92, 100, 108, 118 // upper sub-band (post-DC)
};

// Maximum amplitude buffer size across all supported modes
constexpr uint8_t MAX_AMPLITUDE_BUFFER = 24;
